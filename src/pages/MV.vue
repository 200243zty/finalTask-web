<template>
  <div class="table">
    ...
    >
      ...
      <el-table-column label="MV图片" width="110px" align="center">
...
<!--      </el-table-column>-->
    ...
    >
      <el-form
          ...
          label-width="80px"
      >
        <el-form-item prop="name" label="MV名" size="mini">
...
<!--          </el-radio-group>-->
<!--        </el-form-item>-->
        <el-form-item prop="pic" label="MV封面" size="mini">
          <el-upload
              class="avatar-uploader"
              action="http://localhost:8889/uploadMVImage"
              name="pic"
              :multiple="true"
              :auto-upload="true"
